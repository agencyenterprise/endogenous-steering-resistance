...
# Load .env from the parent directory (AGI-1635-esr-appendices)
...
async def main():
    ...
    episodes_file = base_dir / "data" / "self-correction" / "episodes.json"
    output_file = base_dir / "data" / "self-correction" / "episodes_annotated.json"
