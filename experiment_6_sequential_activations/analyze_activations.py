...
# Latent groups (must match collect_activations.py)
OFF_TOPIC_DETECTORS = [
...
def main():
    ...
    labels_file = base_dir.parent / "AGI-1516-esr-with-vllm" / "data" / "llama-70b-goodfire-l50.csv"
    output_file = base_dir / "data" / "self-correction" / "analysis_results.json"
