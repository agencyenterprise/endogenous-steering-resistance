...
# Off-topic detector latents (separability-based top 25, all with AUC=1.0)
OFF_TOPIC_DETECTORS = [
...
async def main():
    ...
    episodes_file = base_dir / "data" / "self-correction" / "episodes_annotated.json"
    output_file = base_dir / "data" / "self-correction" / "episode_metadata.json"
